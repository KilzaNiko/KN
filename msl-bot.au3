Global $aVersion = [1, 5, 10] ;Major, Minor, Build
...
#pragma compile(LegalCopyright, "Copyright (C) Kevin Quito, Edited for KN")
#pragma compile(FileVersion, 1.5.10)
#pragma compile(ProductVersion, 1.5.10)
#pragma compile(OriginalFilename, "msl-donator.exe")
#pragma compile(AutoItExecuteAllowed, True)

#include-once
#include "bin/_src/imports.au3"
#include "bin/local/imports.au3"
;#RequireAdmin
