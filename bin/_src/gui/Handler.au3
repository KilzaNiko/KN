            ...
            Switch $iCode[0]
                ...
                Case $g_idBtn_Save
                    ...
                    If $iIndex > 0 Then
                        ...
                        Local $sNamePreset = $g_aSchedules[Schedule_IndexByName(StringReplace(StringReplace(_GUICtrlListView_GetItemText($g_hLV_Schedule, $aIndexes[1]), "[ON] ", ""), "[OFF] ", ""))][$SCHEDULE_NAME]
                        ...
                        For $i = 1 To $aIndexes[0]
                            $sFinal &= @CRLF & "||" & @CRLF & _Schedule_ToJson(Schedule_IndexByName(StringReplace(StringReplace(_GUICtrlListView_GetItemText($g_hLV_Schedule, $aIndexes[$i]), "[ON] ", ""), "[OFF] ", "")))
                        Next
                    ...
                    Else
                        MsgBox($MB_ICONWARNING, "Schedule Edit", "Select at least one item.", 5)
                    EndIf
