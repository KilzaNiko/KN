...
Global Const $g_sRemoteUrl = "https://raw.githubusercontent.com/KilzaNiko/msl-bot/version-check/data/"

Global Const $g_sScriptListFile = @ScriptDir & "\bin\local\scriptlist.txt"

Global Const $g_aScriptList = ["_Config", "_Hourly", "_Filter", "Farm Rare", "Farm Golem", "Farm Gem", "Farm Astromon", "Farm Guardian", "Farm Starstone", "Farm_Hero_Dungeons"]
